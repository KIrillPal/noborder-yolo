...
def process_combination(args, gt, pred_groups, N_CLASSES, IMAGE_SHAPE, IOU_THRESHOLD):
    ...
    aggregator = Aggregator(classifier, UnionMerger(N_CLASSES))
    ...
    return (("mask", "union", remove_border, float(input_conf), threshold, float(max_conf)), (f1, precision, recall))
...
if __name__ == '__main__':
    ...
    print(results)
    with open(f'mask_union_gridsearch.pkl', 'wb') as f:
