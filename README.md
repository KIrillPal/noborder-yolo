<div align="center" >
    <h2>NOBORDER-YOLO</h2>
    <h3>Оптимальная агрегация предсказаний YOLOv8 для задачи сегментации объектов на конейерной ленте.</h3>
    <p><i>В данном репозитории будет лежать код модифицированной сети YOLO для обучения без влияния краевых объектов, код агрегации и код для воспроизведения экспериментов.</i></p>
</div>

---

<div align="center" >
<img src="https://progress-bar.xyz/35/?width=500&prefix=Диплом%20готов%20на%20" width=70% />
</div>
...
| --- | --- | --- |
| Литобзор |  ![Progress](https://progress-bar.xyz/50/) | https://confluence.color.iitp.ru/x/vAJUAQ |
...
| Агрегация ConvLSTM | ![Progress](https://progress-bar.xyz/0/) | |
